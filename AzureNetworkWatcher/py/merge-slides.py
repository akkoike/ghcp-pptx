...
表紙のタイトルを「Azure Network Watcher 詳細仕様」に変更して最終 .pptx を出力するスクリプト
"""
import os
import copy
...
CONTENT_PPTX = os.path.join(ROOT_DIR, 'docs', 'AzureNetworkWatcher_content.pptx')
OUTPUT_PPTX = os.path.join(ROOT_DIR, 'docs', 'AzureNetworkWatcher.pptx')

TITLE_TEXT = 'Azure Network Watcher 詳細仕様'

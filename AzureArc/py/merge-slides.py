...
表紙のタイトルを「Azure Arc 詳細仕様」に変更して最終 .pptx を出力するスクリプト
"""
import os
import copy
...
CONTENT_PPTX = os.path.join(ROOT_DIR, 'docs', 'AzureArc_content.pptx')
OUTPUT_PPTX = os.path.join(ROOT_DIR, 'docs', 'AzureArc.pptx')

TITLE_TEXT = 'Azure Arc 詳細仕様'
